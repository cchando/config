...
s.deleteHistoryNewerThan(e,t,n){var o=e.days||0, r=e.hours||0,; chrome.history.deleteRange({startTime:(new Date).getTime()-1e3*(86400*o+3600*r), endTime:(new Date).getTime()}, (function(){})
															)
}
